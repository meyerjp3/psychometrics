...
public class QNMinimizer implements Minimizer<DiffFunction>, HasEvaluators {
    ...
    private ArrayList<String> sayLine = new ArrayList<String>();
...
//            paramRange = Generics.newHashSet(x.length);//commented out by Patrick
            paramRange = new HashSet<Integer>(x.length);//added by Patrick
            for (int i = 0; i < x.length; i++) {
                paramRange.add(i);
            }
        }

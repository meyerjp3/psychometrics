...
public class LikelihoodCrossValidationTest {
    ...
    public void testValue() throws Exception {
        ...
        System.out.println(scott.value());

        GaussianKernel kern = new GaussianKernel();
        LikelihoodCrossValidation lcv = new LikelihoodCrossValidation(kern, x);
        System.out.println(lcv.value());

...
public class HaebaraMethodTest {
    ...
    public void haebaraMethodTestMixedFormat3(){
        System.out.println("Haebara Method Test 5: Mixed format test, symmetric, Graded Response");
        LinkedHashMap<VariableName, ItemResponseModel> irmX = new LinkedHashMap<VariableName, ItemResponseModel>();
        LinkedHashMap<VariableName, ItemResponseModel> irmY = new LinkedHashMap<VariableName, ItemResponseModel>();
    ...
    public void stockingLordTestMixedFormat4(){
        System.out.println("Haebara Method Test 5: Mixed format test, symmetric, Graded Response 2");
        LinkedHashMap<VariableName, ItemResponseModel> irmX = new LinkedHashMap<VariableName, ItemResponseModel>();
        LinkedHashMap<VariableName, ItemResponseModel> irmY = new LinkedHashMap<VariableName, ItemResponseModel>();
    ...
    public void stockingLordTestMixedFormat5(){
        System.out.println("Haebara Method Test 6: Mixed format test, backwards, Graded Response 2");
        LinkedHashMap<VariableName, ItemResponseModel> irmX = new LinkedHashMap<VariableName, ItemResponseModel>();
        LinkedHashMap<VariableName, ItemResponseModel> irmY = new LinkedHashMap<VariableName, ItemResponseModel>();

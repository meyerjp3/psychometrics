 ...
 */
@Deprecated
public class ScaleQualityOutput {

    private ScaleQualityStatistics items = null;

    private ScaleQualityStatistics persons = null;

    public ScaleQualityOutput(ScaleQualityStatistics items, ScaleQualityStatistics persons){
        this.items = items;

 ...
 *
 */
public class VariableAttributes implements Comparable<VariableAttributes> {
     ...
     */
    public VariableAttributes(String name, String label, ItemType itemType, DataType dataType, int order, String itemGroup){
        ...
        specialDataCodes = new SpecialDataCodes();//Use default codes
    }

    public VariableAttributes(VariableName variableName, VariableLabel variableLabel, ItemType itemType, DataType dataType, int order, String itemGroup){
    ...
    public VariableAttributes(String variableName, int order){
     ...
     */
    public double computeItemScore(String response){
    ...
    public double computeItemScore(double response){
        if(Double.NaN==response) return specialDataCodes.computeMissingScore(SpecialDataCodes.PERMANENT_MISSING_DATA_CODE);
...
//===============================================================================================
    public void addAllCategories(String optionScoreKey){
        ItemType added = itemScoring.addAllCategories(optionScoreKey, type);

...
//        optimizer.showDetails(true);//for debugging
    ...
    public void minimize(Uncmin_methods minclass, double[] initialValue, boolean analyticGradient, boolean analyticHessian, int maxIter)throws UncminException{
        ...
        stepmx[1] = 0.5;//should be greater than 0. Values between 0.1 and 3 work well for IRT estimation.

//        System.out.println("UNCMIN initial values = " + Arrays.toString(x) + " CURRENT VALUES = " + Arrays.toString(xpls));
